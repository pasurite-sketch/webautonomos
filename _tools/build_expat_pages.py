...
C['fr'] = dict(
    ...
    faq=[("Mon site en français doit-il respecter la loi espagnole ?",
         ...
         ("Pouvez-vous m'aider à apparaître sur Google Maps en Espagne ?",
          "Oui, avec la gestion de votre fiche Google Business : 29 €/mois, et 90 € pour la créer si vous n'en avez pas encore."),
...
C['en'] = dict(
    ...
    faq=[("Does my English-language website have to comply with Spanish law?",
         ...
         ("Can you help me appear on Google Maps in Spain?",
          "Yes, with Google Business Profile management: €29 a month, plus €90 to create the profile if you don't have one yet."),
