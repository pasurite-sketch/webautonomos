...
C['fr'] = dict(
  ...
  content_g1=[("Vos prestations, clairement listées", "Ce que vous faites, pour qui : un visiteur doit comprendre votre activité en quelques secondes, sur la page d'accueil."),
  ...
  faq=[("Combien coûte un site internet avec WebAutonomos ?",
       ...
       ("Puis-je modifier mon site plus tard ?",
        "Oui. Une modification par mois est incluse : textes, photos, horaires, prestations, prix ou nouvelle section. Vous nous écrivez par WhatsApp ou par e-mail."),
...
C['en'] = dict(
  ...
  lede="We build your affordable, professional website with your services, photos and Google reviews, and send it to you within 24 hours — before you pay anything. The legal pages every Spanish business website needs come as standard.",
  ...
  inc_sd='No hidden costs, no essential extras billed later.',
  inc=['Professional custom design', 'Unlimited adjustments before launch',
       'Fast, secure hosting', 'SSL certificate (https)',
       'Domain name in your name, free for the first year', 'Mobile-friendly site',
  ...
  steps=[('Tell us about your business', 'Your trade, your services, your town: it takes two minutes.'),
         ...
         ('You decide', 'Like it? €15/month and it goes live on your domain. If not, it costs you nothing.')],
  price_ey='Pricing', price_t='One clear price, two payment options',
  ...
  aud=[('⚖️', 'Spanish legal pages included', 'Every business website in Spain must show a legal notice, a privacy policy and a cookie policy (LSSI and GDPR). We write them for you.', '/en/web-design-for-expats-in-spain'),
       ('📍', 'Found by local customers', 'A domain name in your name, titles and text that mention the areas you cover and, if you want, a managed Google Business Profile.'),
  ...
  addons=[('Local SEO', '+€15/month', 'Four articles a month, local keywords and a monthly report so customers in your area find you online.', None),
          ('Google Business Profile', '+€29/month', 'Your profile optimised, 4 posts a month and replies to reviews. Profile creation: €49.', None),
  ...
  content_p="Affordable web design doesn't mean an incomplete result: what matters is what your website contains, not what it costs. Before adding an extra feature, your homepage should clearly show what you do and make it easy to get in touch.",
  ...
  content_g1=[("Your services, clearly listed", "What you do and who for: a visitor should take it in within a few seconds of landing on your homepage."),
              ...
              ("Your photos and Google reviews", "Seeing your work, and what your customers already say about you, reassures a visitor who doesn't know you yet.")],
  ...
  why_pb_pre="In Spain, hiring a freelance web designer typically costs between €800 and €2,000, and a web design agency between €1,500 and €4,000, before ongoing upkeep, according to an ",
  ...
  why_extra_p="For the website itself, your only costs are your plan, monthly or one-off, and the renewal of your domain name from the second year (about €12 a year). A few things fall outside that and go through a separate quote instead, for example:",
  ...
  hcare_ey='After launch', hcare_t='Hosting, security and basic SEO: what continues once you\'re online',
  ...
  hcare_pb="Being affordable doesn't mean being hard to find: your titles and text reflect what you offer and the areas you cover, and your contact details match those on your Google Business Profile — the foundation of good local search visibility.",
  hcare_h3c="What's handled separately",
  ...
  feat_items=[("Your social media", "We add links to your profiles (Facebook, Instagram, LinkedIn…) on your site at no extra cost. If you want to go further, social media management is also possible on request: just ask us."),
              ...
              ("Your Google reviews and photos", "If you have a Google Business Profile, we start from what's already on it to shape the design of your demo: you don't need to write any text yourself.")],
